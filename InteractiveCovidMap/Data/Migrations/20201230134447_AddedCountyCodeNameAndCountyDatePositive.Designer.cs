...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CovidTracking.Models.CountyCodeName", b =>
                {
                    b.Property<int>("CountyCodeNameId")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("StateFips")
                        .HasColumnType("integer");

                    b.Property<string>("StateName")
                        .HasColumnType("text");

                    b.HasKey("CountyCodeNameId");

                    b.HasIndex("CountyCodeNameId");

                    b.HasIndex("CountyFips");

                    b.HasIndex("StateFips");

                    b.ToTable("CountyCodeNames");
                });

            modelBuilder.Entity("CovidTracking.Models.CountyDatePositive", b =>
                {
                    b.Property<int>("CountyDatePositiveId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .UseIdentityByDefaultColumn();
                    ...
                    b.HasKey("CountyDatePositiveId");

                    b.HasIndex("CountyCodeNameId");

                    b.HasIndex("CountyDatePositiveId");

                    b.ToTable("CountyDatePositives");
                });
            ...
            modelBuilder.Entity("CovidTracking.Models.CountyDatePositive", b =>
                {
                    b.HasOne("CovidTracking.Models.CountyCodeName", "CountyCodeName")
                        .WithMany("CountyDatePositives")
                        .HasForeignKey("CountyCodeNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CountyCodeName");
                });

            modelBuilder.Entity("CovidTracking.Models.CountyCodeName", b =>
                {
                    b.Navigation("CountyDatePositives");
                });
